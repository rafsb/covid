					...
					<section class="-row" style="color:#27283D;margin-bottom: 2em">
						...
						<div class="-row -content-center" style="font-size: .75em;">
							<div class='-col-8'>
								...
								<div class="-left -col-3">
									<div class="-left" style="height:1em;width:1em;border-radius:.5em;background:#E84C3D;margin:1em"></div>
									<span class="-left" style="padding:1em">MORTOS</span>
								</div>
								<div class="-row -left"></div>
								<div class="-left -col-3">
									<div class="-left" style="height:1em;width:1em;border-radius:.5em;background:#0003;margin:1em"></div>
									<span class="-left" style="padding:1em">SÉRIE PRINCIPAL¹</span>
								</div>
								<div class="-row -left"></div>
								<b class="-row -left -content-left" style="padding: 1em; color:black">1) A série principal diz respeito ao numero de pessoas que estão infectadas naquele dia e portanto não se recuperaram ainda ou não morreram, não significa novos casos!</b>
							</div>
						</div>
